...
import type {
  ContactsBase,
  Contacts,
  ContactsImageColumnName,
  ContactsUploadColumnName,
...
export class ContactsService {
  ...
  public static async update(
    id: string,
    changedFields: Partial<Omit<ContactsBase, "address1_addressid">>,
  ): Promise<IOperationResult<Contacts>> {
    const result = await ContactsService.client.updateRecordAsync<
      Partial<Omit<ContactsBase, "address1_addressid">>,
      Contacts
  ...
  public static async delete(id: string): Promise<void> {
    await ContactsService.client.deleteRecordAsync(ContactsService.dataSourceName, id);
  }
  ...
  public static async upload(
    id: string,
    columnName: ContactsUploadColumnName,
    file: File,
  ...
  public static async downloadImage(
    id: string,
    columnName: ContactsImageColumnName,
